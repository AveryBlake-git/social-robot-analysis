            ...
            try:
                ...
                try:
                    ...
                    try:
                        ...
                        if int(nextPageJudgment) > 2:  # 如果下一页页码 大于 2页，就停止爬取。
                            pass
                        else:  # 否则就继续爬取
...
if __name__ == '__main__':
    ...
    COOKIES = 'SINAGLOBAL=5697968332478.242.1658855153835; XSRF-TOKEN=b4LUc17b98sQq7PGhEnwjU3s; PC_TOKEN=1ffc095e08; login_sid_t=4349f80ec145e98afb0ffbbdfb14be0f; cross_origin_proto=SSL; WBStorage=267ec170|undefined; _s_tentry=-; Apache=5522249848859.157.1714625195973; ULV=1714625195977:11:1:1:5522249848859.157.1714625195973:1714012778094; WBtopGlobal_register_version=2024050212; SCF=AtFTlqlZqk17LGR6lu_GPuryKgm_sThyF3oxQeesKzweIc8eeOaS_SqnbSoKTOK5WJrU-6Tjf9PhOFTygrnbhAE.; SUB=_2A25LN2qZDeRhGeBJ71cS8irJzzSIHXVoTeJRrDV8PUNbmtANLW2gkW9NRlwG0lBMrBTeyxKgWmE4r858dOFntDNX; SUBP=0033WrSXqPxfM725Ws9jqgMF55529P9D9WFpuZOmTWn5vdjHKKm6NAy.5JpX5o275NHD95QcS0Bfe0zXSKBRWs4DqcjMi--NiK.Xi-2Ri--ciKnRi-zNSoMXSKeESh-X15tt; ALF=1715230025; SSOLoginState=1714625225; un=13641154088; WBPSESS=bqiY6MEEVB3xhBDmz-H-KUfZPihCf5d653nuJsIG6bktSdaQGusDPQD-sIWK2s6krPcT_hVCj2WYg9LeyJhR-5q1neEOk85wrGBFbO4HO_RWaKW4xBfps3HMSd78owJbubP-T9OTdNicwGUUwrzWLA=='
    ...
    from_time = '2024-04-18 12:00:00'  # 爬取的开始时间
    to_time = '2024-04-18 23:59:59'  # 爬取的结束时间
    ...
    # 文件名称
    FILENAMES = f'{FILENAME}04188'

    # 评论文件名称
    COMMENT_FILENAME = f'{FILENAME}评论0418'
